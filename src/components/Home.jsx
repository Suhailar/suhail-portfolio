...
const Home = () => {
  ...
  return (
    <div className='area relative bg-black w-full min-h-[calc(100vh-4rem)]'> {/* Changed from h-screen */}
      <Background />
      <motion.div 
        className='hero absolute inset-0 flex justify-center items-center text-white' 
        id='hero'
        initial={{ opacity: 0, y: 50 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.8, ease: "easeOut" }}
